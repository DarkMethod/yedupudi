...
function ($rootScope, $state, $stateParams) {
    ...
    $rootScope.app = {
        name: 'Yedupudi', // name of your project
        author: 'Yedupudi', // author's name or company name
        description: 'Online NRI services', // brief description
...
app.config(['$localStorageProvider',
    function ($localStorageProvider) {
        $localStorageProvider.setKeyPrefix('yedupudi');
    }]);
